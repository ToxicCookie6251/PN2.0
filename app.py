...
def load_assets():
    ...
    assets["NPC"] = {
        ...
        "servant": load_frames("servant_of_cthulu", 3, scale_factor=1),
        "laser": load_frames("laser_of_cthulu", 3, scale_factor=1)
    }
    ...
    # Sounds
    assets["sounds"] = {
        "shooting": pygame.mixer.Sound(os.path.join("assets", "sounds", "shooting_sound.mp3"))
    }
